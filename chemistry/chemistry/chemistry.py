...
def sum_protons(symbol_quantity_list, periodic_table_dict):
    ...
    for symbol, quantity in symbol_quantity_list:
        if symbol in periodic_table_dict:
            ...
            number_protons += atomic_number * quantity
    return number_protons
def main():
    ...
    # Print the formula name if known, if not, just the formula
    ...
    # Sum the number of protons in the formula
    protons_number = sum_protons(parsed_formula, periodic_table)
    print(f"Number of protons in the formula: {protons_number}")
